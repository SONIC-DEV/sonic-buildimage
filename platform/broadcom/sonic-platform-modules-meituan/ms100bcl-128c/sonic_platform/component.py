...
COMPONENT_LIST = [
    ...
    ("SW_CPLD3",   "Switch board CPLD 3"),
    ("SW_CPLD4",   "Switch board CPLD 4"),
...
SW_CPLD_PLATFORM = "mt3010.switchboard"
...
SW_CPLD2_GETREG_PATH = "{}/{}/CPLD2/getreg".format(
    PLATFORM_SYSFS_PATH, SW_CPLD_PLATFORM)
SW_CPLD3_GETREG_PATH = "{}/{}/CPLD3/getreg".format(
    PLATFORM_SYSFS_PATH, SW_CPLD_PLATFORM)
SW_CPLD4_GETREG_PATH = "{}/{}/CPLD4/getreg".format(
    PLATFORM_SYSFS_PATH, SW_CPLD_PLATFORM)
BIOS_VER_PATH = "/sys/class/dmi/id/bios_version"
FAN_CPLD_VER_PATH = "/sys/bus/i2c/drivers/fancpld/138-000d/version"
...
class Component():
    ...
    def __get_cpld_ver(self):
        ...
        cpld_ver_info = {
            ...
            'SW_CPLD3': self._api_helper.get_register_value(SW_CPLD3_GETREG_PATH, SW_CPLD_VER_REG),
            'SW_CPLD4': self._api_helper.get_register_value(SW_CPLD4_GETREG_PATH, SW_CPLD_VER_REG),
        }
    ...
    def install_firmware(self, image_path):
        ...
        install_command = {
            ...
            "SW_CPLD3": CPLD_UPGRADE_CMD.format(image_path),
            "SW_CPLD4": CPLD_UPGRADE_CMD.format(image_path),
