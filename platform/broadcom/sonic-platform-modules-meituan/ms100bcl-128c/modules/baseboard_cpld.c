/*
 * cpld_b.c - The CPLD driver for the Base Board of mt3010
 * The driver implement sysfs to access CPLD register on the baseboard of mt3010 via LPC bus.
...
#define DRIVER_NAME "mt3010.cpldb"
/**
...
MODULE_DESCRIPTION("Celestica mt3010 CPLD baseboard driver");
